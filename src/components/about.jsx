...
const About = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Outer Container */}
      <div className="max-w-4xl mx-auto bg-gray-100 dark:bg-gray-900 text-black dark:text-white rounded-lg hover:bg-gray-200 dark:hover:bg-gray-800 transform hover:scale-105 transition-transform duration-300 flex flex-col justify-center items-center p-6 sm:p-8">
        ...
        <p className="text-center text-sm sm:text-base md:text-lg leading-relaxed">
          ...
          <span className="italic">(Gojo only lost to the plot btw)</span>, playing soccer, or getting more in tune with streetwear. 
